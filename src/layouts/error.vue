...
<template>
    <div class="margin space-y-4 py-8">
        <div class="space-y-2">
            <h1 class="text-black/90 dark:text-white/90 font-semibold text-2xl">An error occurred</h1>

            <p class="text-lg text-black/50 dark:text-white/30">Here are the details:</p>
        </div>

        <div class="rounded card-base gap-6 flex flex-col md:flex-row">
            <SmartImage
                :src="`https://http.toshiki.dev/${error.statusCode}.png`"
                class="rounded-lg w-full md:w-80 flex-shrink-0"
            />

            <div class="space-y-6 whitespace-normal">
                <div class="flex flex-col space-y-2">
                    <Title> Title </Title>
                    <span class="text-black/50 dark:text-white/30">{{ getErrorMeta.title }}</span>
                </div>

                <div class="flex flex-col space-y-2">
                    <Title> Description </Title>
                    <span class="text-black/50 dark:text-white/30">{{ getErrorMeta.description }}</span>
                </div>
        ...
        <div class="flex items-center justify-between md:justify-start flex-wrap gap-4">
